...
const translations = {
  es: {
    ...
    'sidebar.risk_analysis': 'Análisis de Riesgos ARA',
    'sidebar.bia': 'Análisis de Impacto BIA',
    'sidebar.strategies': 'Estrategias Continuidad',
    'sidebar.criteria': 'Criterios de Estrategia',
    'sidebar.plans': 'Planes de Continuidad',
    'sidebar.tests': 'Pruebas de Continuidad',
    'sidebar.maintenance': 'Mantenimiento SGCN',
  ...
  en: {
    ...
    'sidebar.risk_analysis': 'Risk Analysis ARA',
    'sidebar.bia': 'Impact Analysis BIA',
    'sidebar.strategies': 'Strategies Continuity',
    'sidebar.criteria': 'Strategy Criteria',
    'sidebar.plans': 'Plans Continuity',
    'sidebar.tests': 'Tests Continuity',
  ...
  pt: {
    ...
    'sidebar.risk_analysis': 'Análise de Riscos ARA',
    'sidebar.bia': 'Análise de Impacto BIA',
    'sidebar.strategies': 'Estratégias de Continuidade',
    'sidebar.criteria': 'Critérios de Estratégia',
    'sidebar.plans': 'Planos de Continuidade',
    'sidebar.tests': 'Testes de Continuidade',
